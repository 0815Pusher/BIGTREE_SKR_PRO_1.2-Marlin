...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_BRIGHTNESS 250  // User defined intensity
...
#define FWRETRACT
  ...
  #define RETRACT_LENGTH_SWAP            0.2 // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE              50   // (mm/s) Default feedrate for retracting
  #define RETRACT_ZRAISE                 0.03// (mm) Default retract Z-raise
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    22  // (mm) Slow length, to allow time to insert material.
