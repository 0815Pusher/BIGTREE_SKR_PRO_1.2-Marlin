...
//#define CUSTOM_MACHINE_NAME "MyHellCreator"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi   19.54
  #define DEFAULT_bedKd   491.3
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 1600, 98  }
/**
 * Default Max Feed Rate (mm/s)
 * Override with M203
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 300, 5, 100 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 10, 200 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 5000, 3000, 200, 20000 } // ...or, set your own edit limits
#endif
...
#define HOMING_FEEDRATE_MM_M { (20*30), (25*30), (4*50) }
...
#define NOZZLE_CLEAN_FEATURE
 ...
 #define NOZZLE_CLEAN_END_POINT   { { 70, -10, (Z_MIN_POS + 1) } }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     PE4     // LED driving pin I/O expansion port  2
  ...
  #define NEOPIXEL2_PIN   PE2   // I/O expansion port 2
  //#define NEOPIXEL2_PIN   PD0  // I/O expansion port  2
